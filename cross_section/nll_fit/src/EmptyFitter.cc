...
void MggFitter::FitEmptyWide()
{
	...
	emptyBinSize = h_emptyWide[0]->GetBinWidth(1);
...
void MggFitter::GuessEmptyBkgdParameters()
{
	...
	if(emptyFitOption_bkgd==2) {
		p0Guess =  (h_emptyWide[0]->GetBinContent(h_emptyWide[0]->FindBin(minEmptyFitRange)) - f_emptyWide->Eval(minEmptyFitRange))/emptyBinSize;
...
void MggFitter::GuessEmptyFDCParameters() {
	...
	switch(emptyFitOption_fdc) {
		...
		case 1:
		{
			...
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#mu_{fdc,1}"),    0.750);
			f_emptyWide->FixParameter(f_emptyWide->GetParNumber("#sigma_{fdc,1}"), 0.035);
			
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#mu_{fdc,2}"),    0.619179);
			f_emptyWide->FixParameter(f_emptyWide->GetParNumber("#sigma_{fdc,2}"), 0.027);
			
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#mu_{fdc,3}"),    0.531688);
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#sigma_{fdc,3}"), 0.027);
			
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#mu_{fdc,4}"),    0.453992);
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#sigma_{fdc,4}"), 0.017433);
			
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#mu_{fdc,5}"),    0.398570);
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#sigma_{fdc,5}"), 0.008740);
			
			f_emptyWide->SetParameter(f_emptyWide->GetParNumber("#mu_{fdc,6}"),    0.338665);
			f_emptyWide->FixParameter(f_emptyWide->GetParNumber("#sigma_{fdc,6}"), 0.008873);
