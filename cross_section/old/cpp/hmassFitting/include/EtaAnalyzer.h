...
class EtaAnalyzer {
	public:
			...
			lx2(nullptr) 
		{
			...
			m_rebinsHmass        =  2;
			m_hmassBinSize       =  0.004;
			
			m_rebinsEmptyHmass   =  4;
			m_emptyHmassBinSize  =  0.008;
		...
		void SetRebinsHmass(int);
		void SetRebinsTheta(int);
		void SetRebinsEmptyHmass(int);
		void SetAngularRange(double min, double max) { m_minReconAngle = min; m_maxReconAngle = max; }
		void SetBeamEnergy(double, double);
		void SetBeamEnergy();
		
		double GetHmassBinSize() { return m_hmassBinSize; }
		double GetEmptyHmassBinSize() { return m_emptyHmassBinSize; }
	...
	private:
		...
		int    m_rebinsHmass;
		double m_hmassBinSize;
		
		int    m_rebinsTheta;
		double m_reconAngleBinSize;
		double m_minReconAngle,  m_maxReconAngle;
		
		int    m_rebinsEmptyHmass;
		double m_emptyHmassBinSize;
