...
class MggFitter {
	public:
		...
		double      minFitRange=-0.200,      maxFitRange=0.450;
		double minEmptyFitRange=-0.205, maxEmptyFitRange=0.450;
		
		double minMggCut = -0.1;
		double maxMggCut =  0.1;
	...
	private:
		...
		vector<double> m_muFDC = {0.08, -0.01, -0.12};
